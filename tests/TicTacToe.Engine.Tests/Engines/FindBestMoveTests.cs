...
namespace TicTacToe.Engine.Tests.Engines
{
	[TestFixture(typeof(MiniMaxEngine))]
	[TestFixture(typeof(AlphaBetaPruningEngine))]
	public class FindBestMoveTests<TEngine> where TEngine : IEngine, new()
	{
		[Test]
